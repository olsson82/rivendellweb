<script>
    ...
    var SERVICE_NAME = "<?php echo $id; ?>";
    var TRAN_REMAUTOFILLCART = "<?= $ml->tr('REMAUTOFILLCART') ?>";
    var TRAN_REMSELAUTOFILLCART = "<?= $ml->tr('REMSELAUTOFILLCART') ?>";
    var TRAN_SERVICESAVED = "<?= $ml->tr('SERVICESAVED') ?>";
    var TRAN_COPYTHISCUSTOM = "<?= $ml->tr('COPYTHISCUSTOM') ?>";
