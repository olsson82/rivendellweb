<script>
    ...
    var TRAN_ONLYRIVDATABASE = "<?= $ml->tr('ONLYRIVDATABASE') ?>";
    var TRAN_ONLYRIVWEBDATABASE = "<?= $ml->tr('ONLYRIVWEBDATABASE') ?>";
    var TRAN_BACKUPEVERYTHING = "<?= $ml->tr('BACKUPEVERYTHING') ?>";
    var TRAN_REMOVEBACKUP = "<?= $ml->tr('REMOVEBACKUP') ?>";
    var TRAN_DOWNLOADBACKUP = "<?= $ml->tr('DOWNLOADBACKUP') ?>";    
