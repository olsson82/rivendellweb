<script>
        ...
        var TRAN_DELETEMARKED = "<?= $ml->tr('DELMARKEDCARTS') ?>";
        var TRAN_MARKEDDELETED = "<?= $ml->tr('SELCARTSDEL') ?>";
        var TRAN_SOMECARTSNOTDELETED = "<?= $ml->tr('SOMECARTSNOT') ?>";
        var TRAN_SOMEAREVOICETRACKS = "<?= $ml->tr('SOMECARTSNOTVOICE') ?>";
        var TRAN_NONDELETE = "<?= $ml->tr('SELECTEDNOTDELETEDCARTS') ?>";
        var TRAN_DELETEMARKEDNOTSELECTED = "<?= $ml->tr('SELECTCARTSFIRST') ?>";
        var TRAN_YESCANCEL = "<?= $ml->tr('CLOSEUPLOADWINDOW') ?>";
        var TRAN_SELCARTGROUP = "<?= $ml->tr('SELCARTGROUPFORM') ?>";
        var TRAN_SELCARTTYPE = "<?= $ml->tr('SELCARTTYPEFORM') ?>";
        var TRAN_CLOSEADDCART = "<?= $ml->tr('CLOSEADDCARTWINDOW') ?>";
